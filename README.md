...
4. [Descriptive Analytics](#4-descriptive-analytics)
   - 4.1 [Financial Liability - Demurrage Leakage](#41-financial-liability---demurrage-leakage)
   - 4.2 [Operational Vulnerability - Address Defect Rate](#42-operational-vulnerability---address-defect-rate)
   - 4.3 [Regulatory Exposure - FDPR Matrix](#43-regulatory-exposure---fdpr-matrix)
   - 4.4 [Transactional Integrity - License vs Value Discrepancy](#44-transactional-integrity---license-vs-value-discrepancy)
...
### 3.2 Risk Layer 2: FDPR Auditing
